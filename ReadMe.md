...
Use RouteMatch is used in single page applications to handle routing. It allows you to use a base url and change the path of it while linking it to a component to render.
2. How would you explain form validation to someone who has never programmed before?
Form Validation is basically checking to see if the form input meets certain criteria before it is submitted. For example; a field may require only numbers; so it will not validate if letters are placed in the field.
3. In 1-2 sentences, define end to end testing.
End to end testing involves running a series of mock tests to see if functions and methods produce the desired output. For example, It can be used to automatically test form validation.
